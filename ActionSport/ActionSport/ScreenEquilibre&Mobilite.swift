//
//  ScreenEquilibre&Mobilite.swift
//  ActionSport
//
...
struct ScreenEquilibre_Mobilite: View {
    @StateObject private var vm = ViewModel()
        ...
        var body: some View {
            ...
            HStack {
                Text("Pour devenir super souple !")
                    .font(.system(size: 20))
...
#Preview {
    ScreenEquilibre_Mobilite(text: "Lancer la séance", couleur: .yellow)
}
